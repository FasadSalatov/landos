                        ...
                        <div className="collapse navbar-collapse puvv" id="navbarNav">
                            <ul className="navbar-nav flex gap-4 ps-4">
                                ...
                                <li className="nav-item">
                                    <Link
                                        className={`nav-link pavv ${
                                            location.pathname === "/memes" ? "active-link" : ""
                                        }`}
                                        to="/memes"
                                    >
                                        memes
                                ...
                                <li className="nav-item">
                                    <Link
                                        className={`nav-link pavv ${
                                            location.pathname === "/buy" ? "active-link" : ""
                                        }`}
                                        to="/buy"
                                    >
                                        buy
                                ...
                                <li className="nav-item">
                                    <Link
                                        className={`nav-link pavv ${
                                            location.pathname === "/road" ? "active-link" : ""
                                        }`}
                                        to="/road"
                                    >
                                        roadmap
                            ...
                            <ul className="w-full navbar-nav flex gap-4 ps-4 flex pupu justify-end">
                                <li>
                                    <Link
                                        className={`nav-link pavv ${
                                            location.pathname === "/socials" ? "active-link" : ""
                                        }`}
                                        to="/socials"
                                    >
                                        socials
